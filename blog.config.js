...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'XuzhengChen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '海底捞爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chenxuzheng.top', // 网站地址
